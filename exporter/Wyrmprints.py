...
class UnionAbility(DBView):
    ...
    def get(self, pk, by=None, fields=None, order=None, mode=DBManager.EXACT, exclude_falsy=True, expand_one=True):
...
class AbilityCrest(DBView):
    def __init__(self, index):
        super().__init__(index, 'AbilityCrest', labeled_fields=['_Name', '_Text1', '_Text2', '_Text3', '_Text4', '_Text5'])
