...
python Asset_Download.py -m jpmanifest_with_asset_labels.txt -f ^dragon/motion -out download/
rm -rf ./extract
...
python Asset_Extract.py -i ./download/dragon_motion -o ./extract/dragon_motion