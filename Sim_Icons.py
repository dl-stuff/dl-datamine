...
if __name__ == "__main__":
    pic_index = {
        ...
        "Axe2": {"name": "Critical Damage +30%", "icon": "coabs/Axe2.png", "link": "Critical_Damage_%2B30%25_(Co-ability)"},
        "Blade": {"name": "Strength +10%", "icon": "coabs/Blade.png", "link": "Strength_%2B10%25_(Co-ability)"},
        "Bow": {"name": "Skill Haste +15%", "icon": "coabs/Bow.png", "link": "Skill_Haste_%2B15%25_(Co-ability)"},
        "Dagger": {"name": "Critical Rate +10%", "icon": "coabs/Dagger.png", "link": "Critical_Rate_%2B10%25_(Co-ability)"},
        "Dagger2": {"name": "Standard Attack Damage +20%", "icon": "coabs/Dagger2.png", "link": "Standard_Attack_Damage_%2B20%25"},
        "Lance": {"name": "HP +15%", "icon": "coabs/Lance.png", "link": "HP_%2B15%25_(Co-ability)"},
        "Gun": {"name": "Gauge Accelerator +20%", "icon": "coabs/Gun.png", "link": "Gauge_Accelerator_%2B20%25_(Co-ability)"},
        "Sword": {"name": "Dragon Haste +15%", "icon": "coabs/Sword.png", "link": "Dragon_Haste_%2B15%25_(Co-ability)"},
        "Staff": {"name": "Recovery Potency +20%", "icon": "coabs/Staff.png", "link": "Recovery_Potency_%2B20%25_(Co-ability)"},
        "Wand": {"name": "Skill Damage +15%", "icon": "coabs/Wand.png", "link": "Skill_Damage_%2B15%25_(Co-ability)"},
        "Wand2": {
            "name": "Overdrive Punisher +15%\nGauge Accelerator +10%",
            "icon": "coabs/Wand2.png",
            "link": "Overdrive_Punisher_%26_Gauge_Accelerator_VIII",
        },
